                    ...
                    <div class="header-wrap2">
                        ...
                        <div class="header-button2">
                            <div class="header-button-item js-item-menu">
                                <form id="myForm" action="${pageContext.request.contextPath}/donors?action=search" method="post">
                        ...
                        <div class="col-sm-12">
                            <div class="au-breadcrumb-content">
                                <div class="au-breadcrumb-left mt-1">
                                    <a class="btn btn-primary btn-sm" href="/donors?action=create">
                                        <i class="zmdi zmdi-plus mr-1"></i>New donor</a>
                                </div>
                            ...
                            <div class="table-responsive m-b-40">
                                <table class="table table-borderless table-data3 mydatatable">
                                    ...
                                    <c:forEach var="donor" items="${donorList}">
                                        ...
                                        <tr>
                                            <td><c:out value="${donor.donorName}"/></td>
                                            <td><c:out value="${donor.donorSurrogate}"/></td>
                                            <td><c:out value="${donor.donorAddress}"/></td>
                                            <td><c:out value="${donor.donorEmail}"/></td>
                                            <td><c:out value="${donor.donorPhone}"/></td>
                                            <td><c:out value="${donor.donorMoney}"/></td>
                                            <td><c:out value="${donor.donorTotalMoney}"/></td>
                                            <td>
                                                <a href="/donors?action=view&id=${donor.donorID}"><i class="zmdi zmdi-eye" style="color: blue" title="View"></i></a>
                                                <a href="/donors?action=edit&id=${donor.donorID}"><i class="zmdi zmdi-edit ml-2" style="color: green" title="Edit"></i></a>
                                                <a href="/donors?action=delete&id=${donor.donorID}"><i class="zmdi zmdi-delete ml-2" style="color: red" title="Delete"></i></a>
                                            </td>
                                        </tr>
