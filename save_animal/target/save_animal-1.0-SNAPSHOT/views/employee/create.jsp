                                ...
                                <div class="card-body card-block">
                                    <form action="" method="post" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="employeeGroup" id="text-input" value="${employee.employeeGroup}" placeholder="Group" class="form-control" required>
                                        ...
                                        <div class="row form-group">
                                            <div class="col-12"  align="right">
                                                ...
                                                <a type="reset" class="btn btn-warning btn-sm" href="/employees?action=create" style="width: 90px">
