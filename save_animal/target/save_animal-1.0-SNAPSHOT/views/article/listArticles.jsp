                                ...
                                <table class="table table-borderless table-data3 mydatatable">
                                    ...
                                    <c:forEach var="article" items="${listArticles}">
                                        <tr>
                                            ...
                                            <td>${article.articleCreatedDate}</td>
                                            <td>
                                                <a href="/articles?action=view&activityID=${article.articleID}"><i class="zmdi zmdi-eye" style="color: blue" title="View"></i></a>
                                                <a href="/articles?action=update&activityID=${article.articleID}"><i class="zmdi zmdi-edit ml-2" style="color: green" title="Edit"></i></a>
                                                <a href="/articles?action=delete&activityID=${article.articleID}"><i class="zmdi zmdi-delete ml-2" style="color: red" title="Delete"></i></a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
