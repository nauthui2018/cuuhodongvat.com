...
<head>
    ...
    <!-- Main CSS-->
    <link href="<c:url value="/css/clean-blog.min.css"/>" rel="stylesheet" media="all">
...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand" href="/users">Start Bootstrap</a>
...
<!-- Page Header -->
<header class="masthead" style="background-image: url('${article.articleImage}')">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-10 mx-auto">
              ...
              on ${article.articleCreatedDate}</span>
                </div>
            </div>
        </div>
    </div>
...
<script src="${pageContext.request.contextPath}/vendor/bootstrap-4.1/bootstrap.bundle.min.js"></script>
