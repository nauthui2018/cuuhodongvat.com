                                ...
                                <div class="card-body card-block">
                                    <div class="table-responsive table--no-card m-b-30">
                                        <table class="table table-borderless table-striped table-earning">
                                            <tbody>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0; width: 30%">Title:</td>
                                                <td class="text-left">${article.articleTitle}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0; width: 30%">Author:</td>
                                                <td class="text-left">${article.articleAuthor}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0; width: 30%">Created Date:</td>
                                                <td class="text-left">${article.articleCreatedDate}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0; width: 30%">Reference:</td>
                                                <td class="text-left">${article.articleReference}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0; width: 30%">Image:</td>
                                                <td class="text-left">${article.articleImage}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    <form action="" method="post" class="form-horizontal">
                                        <div class="row form-group">
                                            <input value="${article.getArticleID()}" type="hidden" name="articleID" class="form-control">
