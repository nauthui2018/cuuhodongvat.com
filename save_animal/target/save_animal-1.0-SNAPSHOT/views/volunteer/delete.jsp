...
<div class="page-wrapper">
    ...
    <div class="page-container2">
        ...
        <aside class="menu-sidebar2 js-right-sidebar d-block d-lg-none">
            <div class="logo">
                <a href="#">
                    <img src="viewsimages/icon/logo-white.png" alt="Cool Admin"/>
                </a>
            </div>
                                ...
                                <div class="card-body card-block">
                                    <div class="table-responsive table--no-card m-b-30">
                                        <table class="table table-borderless table-striped table-earning">
                                            <tbody>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0">Image's Volunteer:</td>
                                                <td><img class="img-120 text-left"
                                                         src="<c:url value="${volunteer.image}"/>" alt="anh"></td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0; width: 30%">First Name's
                                                    Volunteer
                                                </td>
                                                <td class="text-left">${volunteer.firstName}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0; width: 30%">Last Name's
                                                    Volunteer
                                                </td>
                                                <td class="text-left">${volunteer.lastName}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0; width: 30%">Date Of
                                                    Birth's Volunteer
                                                </td>
                                                <td class="text-left">${volunteer.dateOfBirth}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0; width: 30%">Addres's
                                                    Volunteer
                                                </td>
                                                <td class="text-left">${volunteer.getAddress()}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0; width: 30%">Mobile's
                                                    Volunteer
                                                </td>
                                                <td class="text-left">${volunteer.mobile}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0; width: 30%">Email's
                                                    Volunteer
                                                </td>
                                            ...
                                            <tr>
                                                <td class="text-right" style="padding-right: 0">Personal Code's
                                                    Volunteer
                                                </td>
                                                <td class="text-left">${volunteer.personalCode}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0">Gender's Volunteer
                                                </td>
                                                <td class="text-left">${volunteer.viewGender(volunteer.gender)}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0">Reason ForRegistration
                                                </td>
                                                <td class="text-left">${volunteer.reasonForRegistration}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0">Registration Program
                                                </td>
                                                <td class="text-left">${volunteer.registrationProgram}</td>
                                            </tbody>
                                            </tbody>
                                        </table>
                                    </div>
                                    <form action="" method="post" class="form-horizontal">
                                        <div class="row form-group">
                                            <input value="${volunteer.id}" type="hidden" name="id" class="form-control">
                                            <div class="col-12" align="center">
                                                <a type="reset" class="btn btn-warning btn-sm"
                                                   href="${pageContext.request.contextPath}/volunteer" style="width: 90px">
