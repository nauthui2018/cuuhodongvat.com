                                ...
                                <div class="card-body card-block">
                                    <form action="" method="post" class="form-horizontal">
                                        <div class="row form-group">
                                            <div class="col-md-2">
                                                <label class="form-control-label" style="font-weight: bolder">Activity Name:</label>
                                            </div>
                                            <div class="col-md-10">
                                                <p class="form-control-label">${activity.activityName}</p>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row form-group">
                                            <div class="col-md-2">
                                                <label class="form-control-label" style="font-weight: bolder">Activity Target:</label>
                                            </div>
                                            <div class="col-md-10">
                                                <p class="form-control-label">${activity.activityTarget}</p>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row form-group">
                                            <div class="col-md-2">
                                                <label class="form-control-label" style="font-weight: bolder">Activity Description:</label>
                                            </div>
                                            <div class="col-md-10">
                                                <p class="form-control-label">${activity.activityDescription}</p>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row form-group">
                                            <div class="col-md-2">
                                                <label class="form-control-label" style="font-weight: bolder">Activity Member:</label>
                                            </div>
                                            <div class="col-md-10">
                                                <p class="form-control-label">${activity.activityMember}</p>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row form-group">
                                            <div class="col-md-2">
                                                <label class="form-control-label" style="font-weight: bolder">Sponsor ID:</label>
                                            </div>
                                            <div class="col-md-10">
                                                <p class="form-control-label">${activity.sponsorID}</p>
                                            </div>
                                        </div>
                                    </form>
                                    <form action="" method="post" class="form-horizontal">
                                        <div class="row form-group">
                                            <div class="col-12"  align="center">
                                                <a type="reset" class="btn btn-primary btn-sm" href="/activities" style="width: 90px">
                                                    <i class="fa fa-check-circle mr-1"></i>Done</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
