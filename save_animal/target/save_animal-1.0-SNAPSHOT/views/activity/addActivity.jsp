                                    ...
                                    <form action="" method="post" class="form-horizontal">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-10">
                                                <input type="text" name="activityName" value="${activity.activityName}" placeholder="Activity Name" class="form-control" required>
                                                <label class="ml-2 mt-2">
                                                    <c:forEach items="${validationResult}" var="item">
                                                        <c:if test="${(item.key).equals('activityName')}">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-10">
                                                <input type="text" name="sponsorID" value="${activity.sponsorID}" placeholder="Sponsor ID" class="form-control" required>
                                                <label class="ml-2 mt-2">
                                                    <c:forEach items="${validationResult}" var="item">
                                                        <c:if test="${(item.key).equals('sponsorID')}">
                                                            <span class="message" style="color: red; font-size: smaller">${item.value}</span>
                                                        </c:if>
                                                    </c:forEach>
                                                </label>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-10">
                                                <textarea id="summernote" name="activityDescription"></textarea>
                                                <label class="ml-2 mt-2">
                                                    <c:forEach items="${validationResult}" var="item">
                                                        <c:if test="${(item.key).equals('activityDescription')}">
                                                            <span class="message" style="color: red; font-size: smaller">${item.value}</span>
                                                        </c:if>
                                                    </c:forEach>
                                                </label>
                                        ...
                                        <div class="row form-group">
                                            <div class="col-12"  align="right">
                                                <a type="reset" class="btn btn-warning btn-sm" href="/activities?action=add" style="width: 90px">
