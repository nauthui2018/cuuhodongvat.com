                    ...
                    <div class="header-wrap2">
                        ...
                        <div class="header-button2">
                            <div class="header-button-item js-item-menu">
                                <form id="myForm"
                                      action="${pageContext.request.contextPath}/subcriber?action=search"
                                      method="post">
                            ...
                            <div class="au-breadcrumb-content">
                                <div class="au-breadcrumb-left mt-1">
                                    <a class="btn btn-primary btn-sm"
                                       href="${pageContext.request.contextPath}/subcriber?action=add">
                                        <i class="zmdi zmdi-plus mr-1"></i>New Subcriber</a>
                                </div>
...
<%--                                                <i class="fa fa-sort" style="color: white"></i></a>--%>
                                    ...
                                    <tbody>
                                    <c:forEach var="sub" items="${subcriber}">
                                        <tr>
                                            <td><c:out value="${sub.id}"/></td>
                                            <td><c:out value="${sub.firstName} ${sub.lastName}"/></td>
                                            <td><c:out value="${sub.email}"/></td>
                                            <td><c:out value="${sub.mobile}"/></td>



                                            <td>
                                                <a href="${pageContext.request.contextPath}/subcriber?action=view&id=${sub.id}"><i
                                                        class="zmdi zmdi-eye" style="color: blue" title="View"></i></a>
                                                <a href="${pageContext.request.contextPath}/subcriber?action=update&id=${sub.id}"><i
                                                        class="zmdi zmdi-edit ml-2" style="color: green"
                                                        title="Edit"></i></a>
                                                <a href="${pageContext.request.contextPath}/subcriber?action=delete&id=${sub.id}"><i
