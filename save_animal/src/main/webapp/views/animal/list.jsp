...
<head>
    ...
    <link href="<c:url value="https://cdn.datatables.net/1.10.22/css/dataTables.bootstrap4.min.css"/>" rel="stylesheet"
          media="all">
                    ...
                    <div class="header-wrap2">
                        ...
                        <div class="header-button2">
                            <div class="header-button-item js-item-menu">
                                <form id="myForm"
                                      action="${pageContext.request.contextPath}/animal?action=search"
                                      method="post">
                        ...
                        <div class="col-sm-12">
                            <div class="au-breadcrumb-content">
                                ...
                                <div class="au-breadcrumb-right m-b-10">
                                    <a class="btn btn-primary btn-sm" href="${pageContext.request.contextPath}/animal?action=''">Home page</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="table-responsive m-b-40">
                                <table class="table table-borderless table-data3 mydatatable">
                                    ...
                                    <tr>
                                        <th>ID</th>
                                        <th>Name
                                            <a href="/animal?action=${requestScope["sort"]}">
                                    ...
                                    <c:forEach var="animals" items="${animal}">
                                        <tr>
                                            <td><c:out value="${animals.id}"/></td>
                                            <td><c:out value="${animals.name}"/></td>
                                            <td><img class="img-120" src="<c:url value="${animals.image}"/>" alt="anh">
                                            </td>
                                            <td><c:out value="${animals.description}"/></td>
                                            <td><c:out
                                                    value="${animals.viewProtectionLevel(animals.protectionLevel)}"/></td>
                                            <td><c:out value="${animals.staffID}"/></td>


                                            <td>
                                                <a href="${pageContext.request.contextPath}/animal?action=view&id=${animals.id}"><i
                                                        class="zmdi zmdi-eye" style="color: blue" title="View"></i></a>
                                                <a href="${pageContext.request.contextPath}/animal?action=update&id=${animals.id}"><i
                                                        class="zmdi zmdi-edit ml-2" style="color: green"
                                                        title="Edit"></i></a>
                                                <a href="${pageContext.request.contextPath}/animal?action=delete&id=${animals.id}"><i
                                                        class="zmdi zmdi-delete ml-2" style="color: red"
                                                        title="Delete"></i></a>
                                            </td>
                                        </tr>
                                    </c:forEach>
