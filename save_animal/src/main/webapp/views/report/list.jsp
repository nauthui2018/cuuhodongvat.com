...
<div class="page-wrapper">
    ...
    <div class="modal" id="myModal">
        <form id="myForm1" action="/reports?action=status&id=${report.reportID}" method="post">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <h5 id="status"></h5> Ban muon thay doi trang thai??
                    <!-- Modal body -->
                    <div class="modal-body">
                        <select name="reportStatus" id="reportStatus" >
                            <c:forEach items="${statusList}" var="status">
                                <c:if test="${status==report.reportStatus}">
                                    <option value="${report.reportStatus}" selected>${status}</option>
                                </c:if>
                                <c:if test="${status!=report.reportStatus}">
                    ...
                    <div class="header-wrap2">
                        ...
                        <div class="header-button2">
                            <div class="header-button-item js-item-menu">
                                <form id="myForm" action="${pageContext.request.contextPath}/reports?action=search" method="post">
                        ...
                        <div class="col-sm-12">
                            <div class="au-breadcrumb-content">
                                <div class="au-breadcrumb-left mt-1">
                                    <a class="btn btn-primary btn-sm" href="/reports?action=create">
                                        <i class="zmdi zmdi-plus mr-1"></i>New Report</a>
                                </div>
                            ...
                            <div class="table-responsive m-b-40">
                                <table class="table table-borderless table-data3 mydatatable">
                                    ...
                                    <c:forEach var="report" items="${reportList}">
                                        ...
                                        <tr>
                                            <td><c:out value="${report.reportPersonName}"/></td>
                                            <td><c:out value="${report.reportAddress}"/></td>
                                            <td><c:out value="${report.reportDescription}"/></td>
                                            <td><c:out value="${report.reportEmail}"/></td>
                                            <td><c:out value="${report.reportPhone}"/></td>
                                            <td><a href="/reports?action=status&id=${report.reportID}" onclick="changeAction(this)" data-toggle="modal" data-target="#myModal">${report.reportStatus}</a></td>
                                            <td>
                                                <a href="/reports?action=view&id=${report.reportID}"><i class="zmdi zmdi-eye" style="color: blue" title="View"></i></a>
                                                <a href="/reports?action=edit&id=${report.reportID}"><i class="zmdi zmdi-edit ml-2" style="color: green" title="Edit"></i></a>
                                                <a href="/reports?action=delete&id=${report.reportID}"><i class="zmdi zmdi-delete ml-2" style="color: red" title="Delete"></i></a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
