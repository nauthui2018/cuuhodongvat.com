                    ...
                    <div class="header-wrap2">
                        ...
                        <div class="header-button2">
                            <div class="header-button-item js-item-menu">
                                <form action="/reports?action=search" method="post">
                                ...
                                <div class="card-body card-block">
                                    <div class="table-responsive table--no-card m-b-30">
                                        <table class="table table-borderless table-striped table-earning">
                                            <tbody>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0; width: 30%">Status:</td>
                                                <td class="text-left">${report.reportStatus}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0; width: 30%">Name:</td>
                                                <td class="text-left">${report.reportPersonName}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0">Address:</td>
                                                <td class="text-left">${report.reportAddress}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0">Email:</td>
                                                <td class="text-left">${report.reportEmail}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0">Phone:</td>
                                                <td class="text-left">${report.reportPhone}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0">Description:</td>
                                                <td class="text-left">${report.reportDescription}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    <form action="/reports?action=delete" method="post" class="form-horizontal">
                                        <div class="row form-group">
                                            <input value="${report.reportID}" type="hidden" name="reportID" class="form-control">
                                            <div class="col-12"  align="center">
                                                <c:if test="${cmt!=null}">
                                                    <p>${cmt}</p>
                                                </c:if>
                                                <a type="reset" class="btn btn-warning btn-sm" href="/reports" style="width: 90px">
