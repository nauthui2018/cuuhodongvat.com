...
<%--                                            <td><c:out value="${volun.status}"/></td>--%>
                                            <td>
                                                ...
                                                <a href="${pageContext.request.contextPath}/volunteer?action=update&id=${volunteer.id}"><i
                                                        class="zmdi zmdi-edit ml-2" style="color: green"
                                                        title="Edit"></i></a>
                                                <a href="${pageContext.request.contextPath}/volunteer?action=delete&id=${volunteer.id}"><i
