                                    ...
                                    <form action="" method="post" class="form-horizontal">
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class=" form-control-label">First Name's Volunteer</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="firstName" value="${volunteer.firstName}"
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class=" form-control-label">Last Name's Volunteer</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="lastName" value="${volunteer.lastName}"
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class="form-control-label">Volunteer's Image</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="image" value="${volunteer.image}"
                                                       placeholder="Image's Volunteer" class="form-control" required>
                                                <%--                                                <label class="ml-2 mt-2">--%>
                                                <%--                                                    <c:forEach items="${validationResult}" var="item">--%>
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class=" form-control-label">Addres's Voluntees</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="addres" value="${volunteer.addres}"
                                                       placeholder="Addres's Volunteer" class="form-control" required>
                                                <%--                                                <label class="ml-2 mt-2">--%>
                                                <%--                                                    <c:forEach items="${validationResult}" var="item">--%>
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class=" form-control-label">Mobile's Voluntees</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="mobile" value="${volunteer.mobile}"
                                                       placeholder="Mobile's Volunteer" class="form-control" required>
                                                <%--                                                <label class="ml-2 mt-2">--%>
                                                <%--                                                    <c:forEach items="${validationResult}" var="item">--%>
                                                <%--                                                        <c:if test="${(item.key).equals('lastName')}">--%>
                                                <%--                                                            <span class="message"--%>
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class=" form-control-label">Email's Voluntees</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="email" name="email" value="${volunteer.email}"
                                                       placeholder="Email's Volunteer" class="form-control" required>
                                                <%--                                                <label class="ml-2 mt-2">--%>
                                                <%--                                                    <c:forEach items="${validationResult}" var="item">--%>
                                                <%--                                                        <c:if test="${(item.key).equals('lastName')}">--%>
                                                <%--                                                            <span class="message"--%>
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class=" form-control-label">Personal Code 's Voluntees</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="personalCode" value="${volunteer.personalCode}"

                                                       placeholder="Personal Code's Volunteer" class="form-control" required>
                                                <%--                                                <label class="ml-2 mt-2">--%>
                                                <%--                                                    <c:forEach items="${validationResult}" var="item">--%>
                                                <%--                                                        <c:if test="${(item.key).equals('lastName')}">--%>
                                                <%--                                                            <span class="message"--%>
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class=" form-control-label">Date Of Birth's Volunteer</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="date" name="dateOfBirth" value="${volunteer.dateOfBirth}"
                                                       placeholder="Date Of Birth's Volunteer" class="form-control" required>
                                                <%--                                                <label class="ml-2 mt-2">--%>
                                                <%--                                                    <c:forEach items="${validationResult}" var="item">--%>
                                                <%--                                                        <c:if test="${(item.key).equals('lastName')}">--%>
                                                <%--                                                            <span class="message"--%>
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="select" class="form-control-label">Gender's Volunteer
                                              </label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class=" form-control-label">Registration Program's Voluntees</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="registrationProgram" value="${volunteer.registrationProgram}"
                                                       placeholder="Registration Program's Voluntees" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class=" form-control-label">Reason For Registration's Voluntees</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="reasonForRegistration" value="${volunteer.reasonForRegistration}"
                                                       placeholder="Reason For Registration's Voluntees" class="form-control" required>
                                            </div>

                                        </div>
                                        <div class="row form-group">
                                            <div class="col-12" align="right">
                                                <a type="reset" class="btn btn-warning btn-sm" href="${pageContext.request.contextPath}/volunteer?action=add"
                                                   style="width: 90px">
