                                    ...
                                    <form action="" method="post" class="form-horizontal">
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class=" form-control-label">Image's Volunteer</label>
                                            </div>
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class=" form-control-label">First Name's
                                                    Subcriber</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class=" form-control-label">Last Name's Subcriber</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class="form-control-label">Email's Volunteer</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="email" value="${volunteer.email}"
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class="form-control-label">Mobile's Volunteer</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="mobile" value="${volunteer.mobile}"
                                                       placeholder="Mobile" class="form-control" required>
                                                <%--                                                <label class="ml-2 mt-2">--%>
                                                <%--                                                    <c:forEach items="${validationResult}" var="item">--%>
                                                <%--                                                        <c:if test="${(item.key).equals('mobile')}">--%>
                                                <%--                                                            <span class="message"--%>
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class="form-control-label">Gender's Volunteer</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <select name="gender" id="select" class="form-control"
                                                    ...
                                                    <c:if test="${volunteer.gender != null}">
                                                        <option value="${volunteer.gender}"
                                                                selected>${volunteer.viewGender(volunteer.gender)}</option>
                                                        <c:forEach var="i" begin="0" end="3">
                                                            <c:if test="${volunteer.gender != i}">
                                                                <option value="${i}">${volunteer.viewGender(i)}</option>
                                                            </c:if>
                                                        </c:forEach>
                                                    </c:if>
                                                </select>
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class=" form-control-label">Date Of Birth's
                                                    Volunteer</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class=" form-control-label">Address's Volunteer</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="address"
                                                       value="${volunteer.getAddress()}"
                                                       placeholder="Address"
                                                       class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class=" form-control-label">Personal Code's
                                                    Volunteer</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="personalCode"
                                                       value="${volunteer.personalCode}"
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class=" form-control-label">Registration Program</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="registrationProgram"
                                                       value="${volunteer.registrationProgram}"
                                                       placeholder="registrationProgram"
                                                       class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class=" form-control-label">Reason For
                                                    Registration</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="reasonForRegistration"
                                                       value="${volunteer.reasonForRegistration}"
                                                       placeholder="registrationProgram"
                                                       class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-12" align="right">
                                                <a type="reset" class="btn btn-warning btn-sm"
                                                   href="${pageContext.request.contextPath}/volunteer?action=update"
                                                   style="width: 90px">
