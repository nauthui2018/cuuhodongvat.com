                                    ...
                                    <div class="table-responsive table--no-card m-b-30">
                                        <table class="table table-borderless table-striped table-earning">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-left"><img src="${donor.donorImage}" width="350" height="400"></td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0; width: 30%">ID:</td>
                                                <td class="text-left">${donor.donorID}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0; width: 30%">Name:</td>
                                                <td class="text-left">${donor.donorName}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0">Surrogate:</td>
                                                <td class="text-left">${donor.donorSurrogate}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0">Email:</td>
                                                <td class="text-left">${donor.donorEmail}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0">Phone:</td>
                                                <td class="text-left">${donor.donorPhone}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0">Address:</td>
                                                <td class="text-left">${donor.donorAddress}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0">Money:</td>
                                                <td class="text-left">${donor.donorMoney}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0">TotalMoney:</td>
                                                <td class="text-left">${donor.donorTotalMoney}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    <form action="" method="post" class="form-horizontal">
                                        <div class="row form-group">
                                            <div class="col-12"  align="center">
                                                <a type="reset" class="btn btn-warning btn-sm" href="/donors" style="width: 180px">
