                            ...
                            <div class="card">
                                <div class="card-body card-block">
                                    <form action="" method="post" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input" class=" form-control-label">Surrogate</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="donorPhone" value="${donor.donorPhone}" placeholder="Phone" class="form-control" required>
                                                <c:forEach items="${validate}" var="item">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-input" name="donorMoney" value="${donor.donorMoney}" placeholder="Money" class="form-control" required>
                                                <c:forEach items="${validate}" var="item">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="donorImage" value="${donor.donorImage}" placeholder="Image" class="form-control" required>
                                                <c:forEach items="${validate}" var="item">
                                        ...
                                        <div class="row form-group">
                                            <div class="col-12"  align="right">
                                                ...
                                                <a type="reset" class="btn btn-warning btn-sm" href="/donors?action=create" style="width: 90px">
