                                ...
                                <div class="card-body card-block">
                                    <div class="table-responsive table--no-card m-b-30">
                                        <table class="table table-borderless table-striped table-earning">
                                            <tbody>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0; width: 30%">Image:</td>
                                                <td class="text-left"><img src="${employee.employeeImage}" width="250" height="300"></td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0; width: 30%">ID:</td>
                                            ...
                                            <tr>
                                                <td class="text-right" style="padding-right: 0">Degree:</td>
                                                <td class="text-left">${employee.employeeDegree}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0">Description:</td>
                                                <td class="text-left">${employee.employeeDescription}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0">Group:</td>
                                                <td class="text-left">${employee.employeeGroup}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0">DOB:</td>
                                                <td class="text-left">${employee.employeeDOB}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0">Email:</td>
                                                <td class="text-left">${employee.employeeEmail}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0">Phone:</td>
                                                <td class="text-left">${employee.employeePhone}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0">Address:</td>
                                                <td class="text-left">${employee.employeeAddress}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0">Number CMND:</td>
                                                <td class="text-left">${employee.employeeCMND}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0">Province:</td>
                                                <td class="text-left">${employee.employeeProvince.provinceName}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" style="padding-right: 0">JoinDate:</td>
                                                <td class="text-left">${employee.employeeJoinDate}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    <form action="" method="post" class="form-horizontal">
                                        <div class="row form-group">
                                            <div class="col-12"  align="center">
                                                <a type="reset" class="btn btn-warning btn-sm" href="/employees" style="width: 180px">
